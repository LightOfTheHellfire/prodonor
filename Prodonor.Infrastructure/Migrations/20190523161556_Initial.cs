        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceForMile = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarrierLocations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarrierLocations_Carriers_CarrierId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserDaoId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Orders_Users_UserDaoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CompanyRolesId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserCompanyRoles_CompanyRoles_CompanyRolesId",
                        column: x => x.CompanyRolesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderToProductDao", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderToProductDao_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderToProductDao_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    StoreRolesId = table.Column<int>(nullable: false),
                    UserId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserStoreRoles_StoreRoles_StoreRolesId",
                        column: x => x.StoreRolesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarrierLocations_CarrierId",
                table: "CarrierLocations",
                column: "CarrierId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_UserDaoId",
                table: "Orders",
                column: "UserDaoId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderToProductDao_OrderId",
                table: "OrderToProductDao",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderToProductDao_ProductId",
                table: "OrderToProductDao",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCompanyRoles_CompanyRolesId",
                table: "UserCompanyRoles",
                column: "CompanyRolesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserStoreRoles_StoreRolesId",
