...
namespace Prodonor.Controllers
{
    ...
    {
        private IApplicationService<CompanyRolesDto> _service;

        public CompanyRolesController(IApplicationService<CompanyRolesDto> service)
        {
            _service = service;
        }
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update([FromBody]CompanyRolesDto CompanyRoles)
        {
            return await ExecForResult(() => _service.UpdateAsync(CompanyRoles));
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Add([FromBody]CompanyRolesDto obj)
        {
