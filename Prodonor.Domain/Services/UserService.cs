...
namespace Prodonor.Domain.Services
{
    public class UserService
    {
        ...
        public async Task<User> Create(User user, string password)
        {
            ...
            var existingRecord = await _repository.GetByNameAsync(user.Username);
        ...
        public async Task Update(User userParam, string password = null)
        {
            ...
            {
                var existingRecord = await _repository.GetByNameAsync(userParam.Username);
            ...
            await _repository.SetModified(user);
        }
